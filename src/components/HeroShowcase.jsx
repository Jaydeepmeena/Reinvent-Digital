    ...
    >
      <TiltCard max={4} glare={false} className="relative aspect-[4/5] sm:aspect-[5/6] lg:aspect-[7/8]">
        ...
        <motion.div
          ...
          className="absolute -right-2 top-[30%] sm:-right-3"
        >
          <span className="flex items-center gap-2 rounded-full bg-ink px-2 py-4 text-[11px] font-bold uppercase tracking-[0.14em] text-cream shadow-lg shadow-ink/25 [writing-mode:vertical-rl] sm:px-2.5 sm:py-5 sm:text-xs">
            <span className="h-2 w-2 rounded-full bg-lime" aria-hidden="true" />
            Accepting new clinics
          </span>
        </motion.div>
